...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        $settings->add(new admin_setting_configtext(
            ...
            get_string('oldterm', 'filter_textsubstitute'),
            get_string('oldtermdesc', 'filter_textsubstitute'),
            '',
            PARAM_TEXT
        ));
        ...
        $settings->add(new admin_setting_configtext(
            ...
            get_string('subterm', 'filter_textsubstitute'),
            get_string('subtermdesc', 'filter_textsubstitute'),
            '',
            PARAM_TEXT
        ));
        ...
        $settings->add(new admin_setting_configmulticheckbox(
            ...
            [FORMAT_MOODLE => 1, FORMAT_HTML => 1, FORMAT_MARKDOWN => 1],
            format_text_menu()
        ));
