...
$string['oldtermdesc'] = 'The old term to replace';
$string['pluginname'] = 'Text Substitute';
$string['privacy:metadata'] = 'The Text Substitute only substitute text';
...
$string['subterm'] = 'Substitute term';
$string['subtermdesc'] = 'The new term to substitute the old term with';
