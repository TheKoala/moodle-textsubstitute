...
final class filter_test extends \advanced_testcase {
     ...
     * @return void
     */
    public function test_filter_textsubstitute($searchterm, $substituteterm, $formats,
        $originalformat, $inputtext, $expectedtext): void {
